...
#ifndef MODBUS_INC_CRC_H_
#define MODBUS_INC_CRC_H_
...
extern unsigned short CRC16(char *puchMsg ,unsigned short usDataLen);

#endif /* MODBUS_INC_CRC_H_ */
